...
export class NewWorkoutComponent implements OnInit, OnDestroy {
  ...
  constructor(private workoutService: WorkoutService, private uiService: UiService) {}
  ...
  ngOnInit() {
    ...
    this.workoutService.availableExercisesChangedEvent.pipe(takeUntil(this.onDestroy$)).subscribe(() => {
